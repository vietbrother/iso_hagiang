...
import com.iso.dashboard.controller.PersonalSendFileController;
 ...
 * @author VIET_BROTHER
 */
public class PersonalSendFileView extends Panel implements View {
...
//        tabSheet.setCaption(BundleUtils.getStringCas("menu.userMngt"));
        ...
        new PersonalSendFileController(this);
