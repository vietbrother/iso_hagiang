...
import com.iso.dashboard.controller.PersonalFileInfoController;
 ...
 * @author VIET_BROTHER
 */
public class PersonalFileInfoView extends Panel implements View {
...
//        tabSheet.setCaption(BundleUtils.getStringCas("menu.userMngt"));
        ...
        new PersonalFileInfoController(this);
